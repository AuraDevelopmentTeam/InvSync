...
public class Config {
  ...
  @NonNull @Getter private final Path configDir;
  ...
  public void load() {
    ...
    @NonNull ConfigurationNode rootNode;
    ...
    Values.Synchronize.enablePotionEffects =
        synchronize.getNode("enablePotionEffects").getBoolean(true);
    ...
    Values.Storage.H2.databaseFile =
        configDir.resolve(h2.getNode("databaseFile").getString("inventoryStorage.db"));
    ...
    if (Values.Storage.MySQL.port < 1) {
      InventorySync.getLogger()
          .warn("MySQL port too low: " + Values.Storage.MySQL.port + "! Defaulting to 1!");
  ...
  public static class Values {
    ...
    public static class Global {
      ...
      @Getter private static int maxWait;
    }

    @UtilityClass
    public static class Synchronize {
      @Getter private static boolean enableInventory;
      @Getter private static boolean enableEnderChest;
      @Getter private static boolean enableGameMode;
      @Getter private static boolean enableExperience;
      @Getter private static boolean enableHealth;
      @Getter private static boolean enableHunger;
      @Getter private static boolean enablePotionEffects;
    }

    @UtilityClass
    public static class Storage {
      @Getter private static String storageEngine;

      @UtilityClass
      public static class H2 {
        @Getter private static Path databaseFile;
      }
